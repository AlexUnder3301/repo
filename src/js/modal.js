const feedbackButton = document.querySelector('.menu-footer__call-icon')
const callorderButton = document.querySelector('.menu-footer__chat-icon')
...
const closeButtonHandler = (element, i) => {
    ...
    document.addEventListener('click', (event) => {
        ...
        const isClickOnModalButton = event.target === feedbackButton || event.target === callorderButton
